...
const createUserWithEmailPasswordRequest = async (email: string, password: string) =>
  await auth
...
function* createUserWithEmailPassword({ payload }: any) {
...
function* signInUserWithEmailPassword({ payload }: any) {
  const { email, password } = payload;
  try {
