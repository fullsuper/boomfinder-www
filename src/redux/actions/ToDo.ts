...
export const fetchTodosSuccess = (mails: any) => {
  return {
    type: FETCH_ALL_TODO_SUCCESS,
    payload: mails,
  };
};
export const fetchTodosConversationSuccess = (mails: any) => {
  return {
...
export const showTodoMessage = (message: string) => {
  return {
    type: SHOW_MESSAGE,
    payload: message,
  };
};
export const onSortEnd = (data: any) => {
  return {
    type: ON_SORTEND,
    payload: data,
  };
...
export const onLabelMenuItemSelect = (label: string) => {
  return {
    type: ON_LABEL_MENU_ITEM_SELECT,
    payload: label,
  };
};
export const onLabelUpdate = (data: any) => {
  return {
    type: ON_LABEL_UPDATE,
    payload: data,
  };
};
export const onMarkAsStart = (data: any) => {
  return {
...
export const onToDoUpdate = (data: any) => {
  return {
    type: ON_TODO_UPDATE,
    payload: data,
  };
...
export const onDeleteToDo = (data: any) => {
  return {
    type: ON_DELETE_TODO,
    payload: data,
  };
};
export const getNavFilters = (data: any) => {
  return {
    type: GET_NAV_FILTERS,
    payload: data,
  };
};
export const getNavLabels = (data: any) => {
  return {
    type: GET_NAV_LABELS,
    payload: data,
  };
...
export const onSearchTodo = (searchText: string) => {
  return {
    type: SEARCH_TODO,
    payload: searchText,
  };
};
export const onTodoChecked = (data: any) => {
  return {
    type: ON_TODO_CHECKED,
    payload: data,
  };
};
export const onTodoAdd = (data: any) => {
  return {
    type: ON_TODO_ADD,
    payload: data,
  };
};
export const onTodoSelect = (todo: any) => {
  return {
    type: ON_TODO_SELECT,
    payload: todo,
  };
...
export const updateSearch = (searchTodo: any) => {
  return {
    type: UPDATE_SEARCH,
    payload: searchTodo,
  };
