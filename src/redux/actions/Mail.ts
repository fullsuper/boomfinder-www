...
export const fetchMailsSuccess = (mails: any) => {
  return {
    type: FETCH_ALL_MAIL_SUCCESS,
    payload: mails
  };
};
export const showMailMessage = (message: any) => {
  return {
    type: SHOW_MESSAGE,
    payload: message
  };
...
export const onFolderMenuItemSelect = (folderId: any) => {
  return {
...
export const onMailLabelMenuItemSelect = (label: any) => {
  return {
...
export const getMailNavFilters = (filter: any) => {
  return {
...
export const onOptionMenuItemSelect = (option: any) => {
  return {
...
export const getMailNavLabels = (label: any) => {
  return {
    type: GET_NAV_LABELS,
    payload: label
  };
};
export const onSearchMail = (searchText: any) => {
  return {
    type: SEARCH_MAIL,
    payload: searchText
  };
};
export const onMailChecked = (data: any) => {
  return {
...
export const onStartSelect = (data: any) => {
  return {
    type: ON_START_SELECT,
    payload: data
  };
};
export const onImportantSelect = (data: any) => {
  return {
    type: ON_IMPORTANT_SELECT,
    payload: data
  };
};
export const onMailSend = (data: any) => {
  return {
    type: ON_MAIL_SEND,
    payload: data
  };
};
export const onMailSelect = (mail: any) => {
  return {
    type: ON_MAIL_SELECT,
    payload: mail
  };
};
export const getNavFolders = (folder: any) => {
  return {
    type: GET_NAV_FOLDER,
    payload: folder
  };
...
export const updateMailSearch = (searchText: any) => {
  return {
    type: UPDATE_SEARCH,
    payload: searchText
  };
