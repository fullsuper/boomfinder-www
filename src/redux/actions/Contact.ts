...
export const fetchContactsSuccess = (contact: any) => {
  return {
    type: FETCH_ALL_CONTACT_SUCCESS,
    payload: contact
  };
};
export const showContactMessage = (message: any) => {
  return {
    type: SHOW_MESSAGE,
    payload: message
  };
...
export const onContactSelect = (data: any) => {
  return {
...
export const onFilterOptionSelect = (option: any) => {
  return {
    type: ON_FILTER_OPTION_SELECT,
    payload: option
  };
};
export const onSaveContact = (data: any) => {
  return {
    type: ON_SAVE_CONTACT,
    payload: data
  };
};
export const onDeleteContact = (data: any) => {
  return {
...
export const filterContact = (userName: any) => {
  return {
    type: FILTER_CONTACT,
    payload: userName
  };
...
export const updateContactUser = (userName: any) => {
  return {
