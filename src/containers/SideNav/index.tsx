...
class SideNav extends React.PureComponent<any, any> {
  ...
  render() {
    const { navCollapsed, isDirectionRTL, drawerType, width, navigationStyle } = this.props;
...
const mapStateToProps = ({ settings }: any) => {
  const { navCollapsed, isDirectionRTL, drawerType, width, navigationStyle } = settings;
